...
class CustomStyleChartComposer:
    ...
    def customScatterChartMarkerSymbolContent():
        predefinedSymbol1 = AAChartSymbolType.triangle.value
        predefinedSymbol2 = AAChartSymbolType.circle.value
        imageSymbol = "url(https://www.highcharts.com/samples/graphics/sun.png)"
