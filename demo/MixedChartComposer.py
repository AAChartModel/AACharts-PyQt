...
from aacharts.aaoptionsmodel.AAPlotOptions import AAPie
...
class MixedChartComposer:
    @staticmethod
    def configureArearangeMixedLineChart():
        return (AAChartModel()
            .titleSet("面积范围均线图")
            .subtitleSet("混合图的一种")
    ...
    @staticmethod
    def configureColumnrangeMixedLineChart():
        return (AAChartModel()
            .titleSet("城市气温指数")
            .subtitleSet("虚拟数据")
            .yAxisTitleSet("摄氏度")
    ...
    @staticmethod
    def configureStackingColumnMixedLineChart():
        return (AAChartModel()
            ...
            AASeriesElement()
                ...
                .dataSet(
                [198.66, 330.81, 151.95, 160.12, 222.56, 229.05, 128.53, 250.91, 224.47, 473.99, 126.85, 260.50])
                .dataLabelsSet(
                AADataLabels()
                    .enabledSet(True)
                    .styleSet(
            ...
            AASeriesElement()
                ...
                .dataSet(
                [281.55, 398.35, 214.02, 219.55, 289.57, 296.14, 164.18, 322.69, 306.08, 552.84, 205.97, 332.79])
                .dataLabelsSet(
                AADataLabels()
                    .enabledSet(True)
                    .styleSet(
    ...
    @staticmethod
    def configureDashStyleTypesMixedChart():
        return (AAChartModel()
    ...
    @staticmethod
    def configureDashStyleTypeMixedChart():
        return (AAChartModel()
    ...
    @staticmethod
    def configureNegativeColorMixedChart():
        return (AAChartModel()
            .titleSet("")
            .yAxisTitleSet("")
    ...
    @staticmethod
    def configureScatterMixedLineChart():
        return (AAChartModel()
    ...
    @staticmethod
    def configureNegativeColorMixedBubbleChart():
        return (AAChartModel()
    ...
    @staticmethod
    def configurePolygonMixedScatterChart():
        return (AAChartModel()
            .seriesSet([
            AASeriesElement()
                .nameSet("目标")
            ...
            AASeriesElement()
                ...
                AAMarker()
                    ...
                    .symbolSet(
                    AAChartSymbolType.circle.value)  # 曲线点类型："circle", "square", "diamond", "triangle","triangle-down"，默认是"circle"
    ...
    @staticmethod
    def configurePolarChartMixedChart():
        return (AAChartModel()
            .chartTypeSet(AAChartType.column)
            .polarSet(True)
            .seriesSet([
    ...
    @staticmethod
    def configureColumnMixedScatterChart():
        return (AAChartModel()
            .xAxisReversedSet(True)
            .seriesSet([
                AASeriesElement()
    ...
    @staticmethod
    def configurePieMixedLineMixedColumnChart():
        columnElement1 = (AASeriesElement()
            .nameSet("Anna")
            .typeSet(AAChartType.column)
            .dataSet([3, 2, 1, 3, 4]))
        
        columnElement2 = (AASeriesElement()
            .nameSet("Babara")
            .typeSet(AAChartType.column)
            .dataSet([2, 3, 5, 7, 6]))
        
        columnElement3 = (AASeriesElement()
            .nameSet("Cortana")
            .typeSet(AAChartType.column)
            .dataSet([4, 3, 3, 9, 0]))
        
        lineElement = (AASeriesElement()
    ...
    @staticmethod
    def configureLineChartWithShadow():
        return (AAChartModel()
            .chartTypeSet(AAChartType.line)
    ...
    @staticmethod
    def configureNegativeColorMixedAreasplineChart():
        return (AAChartModel()
            ...
            .seriesSet([
                AASeriesElement()
                    ...
                    .negativeColorSet(AAColor.rgbaColor(255, 0, 0, 1.0))
    ...
    @staticmethod
    def configureAerasplinerangeMixedColumnrangeMixedLineChart():
        return (AAChartModel()
            .chartTypeSet(AAChartType.line)
            .dataLabelsEnabledSet(True)
